...
class VehicleGraphics(object):
    ...
    BLACK = (60, 60, 60)
    PURPLE = (200, 0, 150)
    DEFAULT_COLOR = [YELLOW, GREEN]
    EGO_COLOR = GREEN
    num_of_cars = 0

    @classmethod
    def display(cls, vehicle: Vehicle,id:int,surface: "WorldSurface", transparent: bool = False, offscreen: bool = False,
        ...
        pygame.draw.rect(vehicle_surface, cls.get_color(v, id,transparent), rect, 0)
    ...
    @classmethod
    def get_color(cls, vehicle: Vehicle, id:int, transparent: bool = False) -> Tuple[int]:
        color = cls.DEFAULT_COLOR[id]
